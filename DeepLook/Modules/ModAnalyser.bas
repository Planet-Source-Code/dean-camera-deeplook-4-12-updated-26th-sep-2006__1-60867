...
Public Sub AnalyseGroup(GroupFileName As String) ' Master command to analyse a Group (.vbg) file.
    ...
    With FrmResults.TreeView.Nodes
        .Add , , "GROUP", "Project Group", "Group" 'Add the group to the treeview
...
Public Sub AnalyseVBProject(ProjectFileName As String, Optional StartupProjectInGroup As Boolean) 'Master command to analyse a VB Project
    ...
    With FrmSelProject
        .pgbAPB.Value = 0
        .lblScanPhase.Caption = "Code Scan Phase"
    ...
    If Not FileExists(FilesRootDirectory & ProjectFileName) And Not FileExists(ProjectFileName) Then
        If UsesGroup Then
            If ShowFNFerrors And Not IsExit Then MsgBoxEx "Project file """ & ProjectFileName & """ not found!", vbCritical, "DeepLook - Scan Error", , , , , PicError, "Oops!|", 5 'Throw an error if the file cannot be found (only shown if show FNF errors setting turned on)
...
Private Sub AddProjectToTreeView() ' Sub to add all the standard nodes to the treeview (Forms, Project Info, etc.)
    ...
    With FrmResults.TreeView.Nodes ' Looks better with a "With" statement
        ...
        .Add ProjectRootNode, tvwChild, "PROJECT_?_TOTALS", "Project Totals", "ProjStats"
        ...
        .Add ProjectRootNode, tvwChild, "PROJECT_?_PROJINFO", "Project File Information", "ProjFileInfo"
...
Private Sub AddDataToTreeview(PluralItemName As String, linedata As String, TVPic As String, Optional ResFile As String)    'Adds collected data about the current object to the treeview
    ...
    With FrmResults.TreeView.Nodes ' Add calculated statistics to treeview
        ...
        If TVPic <> "Module" And TVPic <> "Class" And TVPic <> "Designer" Then
            .Add Temp, tvwChild, ParentItemNum & "_CONTROLS", "Controls (Inc. All Array Objects): " & ProjectItem.PrjItemControls, "Info"
            .Add Temp, tvwChild, ParentItemNum & "_CONTROLSNA", "Controls (Not Inc. All Array Objects): " & (ProjectItem.PrjItemControls - ProjectItem.PrjItemControlsNoArrays), "Info"
        End If

        TotalLines = ProjectItem.PrjItemHybridLines + ProjectItem.PrjItemCommentLines + ProjectItem.PrjItemCodeLines

        .Add Temp, tvwChild, ParentItemNum & "_LINES", "Code Lines (Inc. Blanks): " & ProjectItem.PrjItemCodeLines & " [" & Round((100 / IIf(TotalLines, TotalLines, 1)) * ProjectItem.PrjItemCodeLines, 2) & "%]", "Info"
        .Add Temp, tvwChild, ParentItemNum & "_LINESNB", "Code Lines (No Blanks): " & ProjectItem.PrjItemCodeLinesNoBlanks & " [" & Round((100 / IIf(TotalLines, TotalLines, 1)) * ProjectItem.PrjItemCodeLinesNoBlanks, 2) & "%]", "Info"
        .Add Temp, tvwChild, ParentItemNum & "_COMMENTLINES", "Comment Lines: " & ProjectItem.PrjItemCommentLines & " [" & Round((100 / IIf(TotalLines, TotalLines, 1)) * ProjectItem.PrjItemCommentLines, 2) & "%]", "Info"
        .Add Temp, tvwChild, ParentItemNum & "_HYBRIDLINES", "Hybrid Lines: " & ProjectItem.PrjItemHybridLines & " [" & Round((100 / IIf(TotalLines, TotalLines, 1)) * ProjectItem.PrjItemHybridLines, 2) & "%]", "Info"
        .Add Temp, tvwChild, ParentItemNum & "_VARIABLES", "Declared Variables: " & ProjectItem.PrjItemVariables, "Info"
        .Add Temp, tvwChild, ParentItemNum & "_CONSTANTS", "Declared Constants: " & ProjectItem.PrjItemConstants, "Info"
        .Add Temp, tvwChild, ParentItemNum & "_TYPES", "Declared Types: " & ProjectItem.PrjItemTypes, "Info"
        .Add Temp, tvwChild, ParentItemNum & "_ENUMS", "Declared Enums: " & ProjectItem.PrjItemEnums, "Info"

        .Add Temp, tvwChild, ParentItemNum & "_SUBS", "Subs", "Method"
        .Add Temp, tvwChild, ParentItemNum & "_FUNCTIONS", "Functions", "Method"
        .Add Temp, tvwChild, ParentItemNum & "_PROPERTIES", "Properties", "Property"

        If TVPic <> "Module" And TVPic <> "Designer" Then .Add GetNodeNum(ParentItemNum), tvwChild, ParentItemNum & "_EVENTS", "Events", "Event"

        .Add Temp, tvwChild, ParentItemNum & "_STATMEMENTS", "Statements", "CodeLoop"
        ...
        If CheckForMalicious Then
            .Add Temp, tvwChild, ParentItemNum & "_PMC", "Potentially Malicious Code", "BadCode"
            .Add GetNodeNum(ParentItemNum & "_PMC"), tvwChild, ParentItemNum & "_PMC_COUNT", "Total: " & UBound(PMaliciousCode), "Info"
        ...
        .Add GetNodeNum(ParentItemNum & "_SUBS"), tvwChild, ParentItemNum & "_SUB_COUNT", "Total: " & Temp, "Info"
        For LoopVar = 1 To Temp
            ...
            If ShowIndividualLines Then
                ...
                .Add GetNodeNum(ParentItemNum & "_SUB" & LoopVar), tvwChild, ParentItemNum & "_SUB" & LoopVar & "_LINES", "Lines (Inc. Blanks): " & Mid$(SPFData, cpPos, InStrRev(SPFData, ":") - cpPos), "Info"
                .Add GetNodeNum(ParentItemNum & "_SUB" & LoopVar), tvwChild, ParentItemNum & "_SUB" & LoopVar & "_LINESNB", "Lines (No Blanks): " & Mid$(SPFData, InStr(1, SPFData, ":") + 1), "Info"
            End If
        Next

        Temp = ProjectItem.PrjItemItemFunctionsCount
        .Add GetNodeNum(ParentItemNum & "_FUNCTIONS"), tvwChild, ParentItemNum & "_FUNCTION_COUNT", "Total: " & Temp, "Info"
        For LoopVar = 1 To Temp
            ...
            If ShowIndividualLines Then
                cpPos = InStr(1, SPFData, ";") + 1
                .Add GetNodeNum(ParentItemNum & "_FUNCTION" & LoopVar), tvwChild, ParentItemNum & "_FUNCTION" & LoopVar & "_LINES", "Lines (Inc. Blanks): " & Mid$(SPFData, cpPos, InStrRev(SPFData, ":") - cpPos), "Info"
                .Add GetNodeNum(ParentItemNum & "_FUNCTION" & LoopVar), tvwChild, ParentItemNum & "_FUNCTION" & LoopVar & "_LINESNB", "Lines (No Blanks): " & Mid$(SPFData, InStr(1, SPFData, ":") + 1), "Info"
            End If
        Next

        Temp = ProjectItem.PrjItemItemPropertiesCount
        .Add GetNodeNum(ParentItemNum & "_PROPERTIES"), tvwChild, ParentItemNum & "_PROPERTY_COUNT", "Total: " & Temp, "Info"
        For LoopVar = 1 To Temp
            ...
            If ShowIndividualLines Then
                ...
                .Add GetNodeNum(ParentItemNum & "_PROPERTY" & LoopVar), tvwChild, ParentItemNum & "_PROPERTY" & LoopVar & "_LINES", "Lines (Inc. Blanks): " & Mid$(SPFData, cpPos, InStrRev(SPFData, ":") - cpPos), "Info"
                .Add GetNodeNum(ParentItemNum & "_PROPERTY" & LoopVar), tvwChild, ParentItemNum & "_PROPERTY" & LoopVar & "_LINESNB", "Lines (No Blanks): " & Mid$(SPFData, InStr(1, SPFData, ":") + 1), "Info"
            End If
        Next

        If TVPic <> "Module" And TVPic <> "Designer" Then
            Temp = GetNodeNum(ParentItemNum & "_EVENTS")
            .Add Temp, tvwChild, ParentItemNum & "_EVENTS_COUNT", "Total: " & ProjectItem.PrjItemItemEventsCount, "Info"
...
Private Sub FixPrjTreeViewItems() ' Sub to fix up captions and keys of the treeview's nodes
    ...
    With FrmResults.TreeView.Nodes ' "With" statement looks better - cleaner code
        ...
        .Item(ItemKeyNum).Text = "Title: " & IIf(Project.ProjectTitle = vbNullString, Project.ProjectName, Project.ProjectTitle)
        ...
        .Item(ItemKeyNum).Text = "Lines (Inc. Blanks): " & IIf(Project.ProjectLines, Format$(Project.ProjectLines, "###,###,###") & " [" & Round((100 / (Project.ProjectLines + Project.ProjectCommentLines)) * Project.ProjectLines, 2) & "%]", "0")

        TotalLines = TotalLines + Project.ProjectLines

        ItemKeyNum = GetNodeNum("PROJECT_?_LINESNB")
        .Item(ItemKeyNum).Text = "Lines (No Blanks): " & IIf(Project.ProjectLinesNB, Format$(Project.ProjectLinesNB, "###,###,###") & " [" & Round((100 / (Project.ProjectLines + Project.ProjectCommentLines)) * Project.ProjectLinesNB, 2) & "%]", "0")

        ItemKeyNum = GetNodeNum("PROJECT_?_LINESCOMMENT")
        .Item(ItemKeyNum).Text = "Lines (Comment): " & IIf(Project.ProjectCommentLines, Format$(Project.ProjectCommentLines, "###,###,###") & " [" & Round((100 / (Project.ProjectLines + Project.ProjectCommentLines)) * Project.ProjectCommentLines, 2) & "%]", "0")
        ...
        .Item(ItemKeyNum).Text = "Lines: " & MaskData(.Item(ItemKeyNum).Text)
        ...
        .Item(ItemKeyNum).Text = "Declared Variables: " & MaskData(.Item(ItemKeyNum).Text)
        ...
        .Item(ItemKeyNum).Text = "Declared Variables: " & ZeroIfNull(Format$(Project.ProjectVariables, "###,###,###"))

        ItemKeyNum = GetNodeNum("PROJECT_?_CONSTANTS")
        .Item(ItemKeyNum).Text = "Declared Constants: " & ZeroIfNull(Format$(Project.ProjectConstants, "###,###,###"))

        ItemKeyNum = GetNodeNum("PROJECT_?_TYPES")
        .Item(ItemKeyNum).Text = "Declared Types: " & ZeroIfNull(Format$(Project.ProjectTypes, "###,###,###"))

        ItemKeyNum = GetNodeNum("PROJECT_?_ENUMS")
        .Item(ItemKeyNum).Text = "Declared Enums: " & ZeroIfNull(Format$(Project.ProjectEnums, "###,###,###"))
        ...
        .Item(ItemKeyNum).Text = "Average Lines in Subs: " & Format$(Round(Project.ProjectSubLines / IIf(TotalSubs, TotalSubs, 1), 2), "###,###.##")

        ItemKeyNum = GetNodeNum("PROJECT_?_SPF_AVRFUNCLINES")
        .Item(ItemKeyNum).Text = "Average Lines in Functions: " & Format$(Round(Project.ProjectFuncLines / IIf(TotalFunctions, TotalFunctions, 1), 2), "###,###.##")

        ItemKeyNum = GetNodeNum("PROJECT_?_SPF_AVRPROPLINES")
        .Item(ItemKeyNum).Text = "Average Lines in Properties: " & Format$(Round(Project.ProjectPropLines / IIf(TotalProperties, TotalProperties, 1), 2), "###,###.##")
...
Private Sub GetProjectEXEStats()
    ...
    With FrmResults.TreeView.Nodes
        ...
        .Add GetNodeNum("PROJECT_?_EXESTATS"), tvwChild, "PROJECT_?_EXESTATS_PATH", "File Path: " & FixRelPath(GetRootDirectory(Project.ProjectPath) & Project.ProjectEXEPath), "Info"
...
IsProjectReference:
    ...
    FrmResults.TreeView.Nodes.Add GetNodeNum("PROJECT_?_REFCOM_REFERENCE_" & RefName), tvwChild, "PROJECT_?_REFCOM_REFERENCE_" & RefName & "_DESC", "Description: Referenced Project", "Info"
End Sub
...
Private Sub GetDecDllStats(linedata As String)  ' Gets statistics on a declared DLL
    ...
    If FileExists(Environ("windir") & "\System\" & DLLFName) Then
        ...
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_PATH", "File Path: " & Environ("windir") & "\System\" & DLLFName, "Info"
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_SIZE", "File Size: " & FileInfo.ByteSize, "Info"
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_COMPANYNAME", "Company Name: " & FileInfo.CompanyName, "Info"
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_DESCRIPTION", "Description: " & FileInfo.FileDescription, "Info"
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_VERSION", "Version: " & FileInfo.FileVersion, "Info"
    ElseIf FileExists(Environ("windir") & "\System32\" & DLLFName) Then
        FileInfo.FindFileInfo Environ("windir") & "\System32\" & DLLFName, False
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_PATH", "File Path: " & Environ("windir") & "\System32\" & DLLFName, "Info"
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_SIZE", "File Size: " & FileInfo.ByteSize, "Info"
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_COMPANYNAME", "Company Name: " & FileInfo.CompanyName, "Info"
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_DESCRIPTION", "Description: " & FileInfo.FileDescription, "Info"
        FrmResults.TreeView.Nodes.Add DLLRootNodeNum, tvwChild, "PROJECT_?_DECDLLS_" & UCase$(DLLFName) & "_VERSION", "Version: " & FileInfo.FileVersion, "Info"
...
Private Sub GetFormStats(linedata As String)  ' Gets the statistics about the form
    ...
    If Mid$(linedata, 2, 1) = ":" Then
        If Not FileExists(linedata) Then
            If ShowFNFerrors And Not IsExit Then MsgBoxEx "File """ & linedata & """ not found!", vbCritical, "DeepLook - Scan Error", , , , , PicError, "Oops!|"
    ...
    Else
        If Not FileExists(GetRootDirectory(Project.ProjectPath) & linedata) Then
            If Not FileExists(FilesRootDirectory & GetRootDirectory(Project.ProjectPath) & linedata) Then 'File not found, show an error
                If ShowFNFerrors And Not IsExit Then MsgBoxEx "File """ & GetRootDirectory(Project.ProjectPath) & linedata & """ not found!", vbCritical, "DeepLook - Scan Error", , , , , PicError, "Oops!|"
                FrmResults.TreeView.Nodes.Add GetNodeNum("PROJECT_?_FORMS"), tvwChild, "PROJECT_?_FORMS_" & linedata, linedata, "Unknown"
                Exit Sub
            Else
...
Private Sub AddFontsToTreeview() ' Adds found used fonts to the treeview
    ...
    With FrmResults.TreeView.Nodes
        .Add GetNodeNum("PROJECT_?"), tvwChild, "PROJECT_?_FONTS", "Used Fonts", "Font"
        .Add GetNodeNum("PROJECT_?_FONTS"), tvwChild, "PROJECT_?_FONTS_TOTAL", "Total: " & UBound(UsedFonts), "Info"
