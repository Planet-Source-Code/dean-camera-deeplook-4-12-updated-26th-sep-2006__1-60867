...
Public Sub CopyDLLOCX()
    ...
    FrmResults.sbrStatus.Caption = "STAT>Commencing File Copy..."
    ...
    FrmResults.sbrStatus.Caption = "STAT>File Copy Complete. Files copied to " & GetRootDirectory(ProjectPath) & "Res\" & "."
End Sub
