...
Begin VB.Form FrmResults 
   ...
   Begin VB.PictureBox pbxControlPanel 
      ...
      Begin DeepLook.ucButtons_H btnSaveUVSList 
         ...
         _ExtentX        =   4260
         _ExtentY        =   661
         Caption         =   "Save Unused Variable List"
         CapAlign        =   2
         BackStyle       =   2
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
   ...
   Begin VB.Frame fmePieChart 
      ...
      Begin VB.PictureBox pbxPieChartSubFrame 
         ...
         Begin MSChart20Lib.MSChart chtGroupChart 
            Height          =   2175
            Left            =   0
            OleObjectBlob   =   "FrmResults.frx":D4B8
            TabIndex        =   28
            Top             =   -480
            Width           =   3015
         End
         Begin MSChart20Lib.MSChart chtFileChart 
            Height          =   2175
            Left            =   6240
            OleObjectBlob   =   "FrmResults.frx":F209
            TabIndex        =   30
            Top             =   -480
            Width           =   2535
         End
         Begin MSChart20Lib.MSChart chtProjectChart 
            Height          =   2175
            Left            =   2880
            OleObjectBlob   =   "FrmResults.frx":115B1
            TabIndex        =   50
            Top             =   -480
            Width           =   3015
         End
         Begin MSChart20Lib.MSChart chtSPFChart 
            Height          =   2175
            Left            =   9000
            OleObjectBlob   =   "FrmResults.frx":13644
            TabIndex        =   51
            Top             =   -480
            Width           =   3015
         End
    ...
    With TreeView
        ...
        Else
            If ShowItemKey = True Then
                sbrStatus.Caption = "STAT>" & .SelectedItem.Key & " (" & .SelectedItem.Index & ") Node Total: " & .Nodes.Count
            Else
                sbrStatus.Caption = "STAT>Current Node Location: " & CurrKey
            End If
        End If
...
Private Sub btnFileCopy_Click()
    With FrmCopyReport
        ...
        .Caption = "DeepLook Copy Required Files Report"
...
Private Sub btnGenerateReport_Click()
    ...
    btnGenerateReport.Caption = "Wait..."
        
    FrmReport.CreateTempXMLReport
    
    btnGenerateReport.Caption = "Show Project Report"
...
Private Sub btnSaveUVSList_Click()
    ...
    cdgDialogs.Filter = "DeepLook Report File (*.txt)|*.txt"
    cdgDialogs.ShowSave
    ...
    If FileExists(cdgDialogs.FileName) Then
        I = MsgBoxEx("File """ & cdgDialogs.FileName & """ already exists. Overwrite?", vbExclamation Or vbYesNo, "DeepLook", , , , , PicReport)
