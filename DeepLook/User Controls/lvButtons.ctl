...
Private Sub DrawCaptionIcon(bColor As Long, Optional tColorDisabled As Long = -1, _
    ...
    If LenB(myProps.bCaption) = 0 Then Exit Sub
    ...
    If Left$(myProps.bCaption, 5) = "STAT>" Then
        DrawText ButtonDC.hdc, Mid$(sCaption, 6), Len(sCaption) - 5, tRect, DT_WORDBREAK Or Choose(myProps.bCaptionAlign + 1, DT_LEFT, DT_RIGHT, DT_CENTER)
    Else
        DrawText ButtonDC.hdc, sCaption, Len(sCaption), tRect, DT_WORDBREAK Or Choose(myProps.bCaptionAlign + 1, DT_LEFT, DT_RIGHT, DT_CENTER)
    End If
